...
set_target_properties(Qt6::LanguageServerPrivate PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libQt6LanguageServer.so.6.7.2"
  IMPORTED_SONAME_RELEASE "libQt6LanguageServer.so.6"
  )

list(APPEND _cmake_import_check_targets Qt6::LanguageServerPrivate )
list(APPEND _cmake_import_check_files_for_Qt6::LanguageServerPrivate "${_IMPORT_PREFIX}/lib/libQt6LanguageServer.so.6.7.2" )
